...
function IntroPage() {
  return (
    <div className={classes.mainbody}>
      ...
      {/*<img
        alt="Multi colored map"
        src={Multicolor}
        className={classes.Multicolor}
      />*/}
      <img
        alt="Nashville map colored Yellow"
        src={NashvilleYellow}
        className={classes.NashvilleYellow}
      />
    </div>
  );
}
